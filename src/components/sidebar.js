              ...
              <div className="flex items-center ms-3">
                ...
                >
                  <div className="px-4 py-3" role="none">
                    <p className="text-sm text-gray-300  " role="none">
                      Neil Sims
                    </p>
                    <p
        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-[#135D66]  ">
          <ul className="space-y-2 font-medium">
           ...
           href="/device"
              ...
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-gray-300 transition duration-75 group-hover:text-white  "
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Decive</span>
            ...
            <li>
            <button type="button" className="flex items-center w-full p-2 text-base text-gray-300 transition duration-75 rounded-lg group hover:text-white" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  <svg className="flex-shrink-0 w-5 h-5 text-gray-300 transition duration-75 group-hover:text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 21">
                     <path d="M15 12a1 1 0 0 0 .962-.726l2-7A1 1 0 0 0 17 3H3.77L3.175.745A1 1 0 0 0 2.208 0H1a1 1 0 0 0 0 2h.438l.6 2.255v.019l2 7 .746 2.986A3 3 0 1 0 9 17a2.966 2.966 0 0 0-.184-1h2.368c-.118.32-.18.659-.184 1a3 3 0 1 0 3-3H6.78l-.5-2H15Z"/>
                  </svg>
                  <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Phone Book</span>
