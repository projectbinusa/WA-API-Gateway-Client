      ...
      <div className="bg-gray-50 rounded-md p-3">
        <div className="flex justify-between border-b-2">
          ...
          <div className="content-center">
            <div>
               <button data-modal-target="default-modal" data-modal-toggle="default-modal" type="button" className="border ordber-gray-300 focus:outline-none focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5  bg-gray-800  text-white  border-gray-600  hover:bg-gray-700  hover:border-gray-600  focus:ring-gray-700">
            Add Device
          </button>
            </div>
          </div>
