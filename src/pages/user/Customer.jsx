...
import { url_user_customer } from "../../utils/baseURL";
...
function Customer() {
  ...
  const getCustomerById = (customerId) => {
    axios
      .get(`${url_user_customer}/${customerId}`, authorization)
      .then((res) => {
  ...
  const handleSubmit = () => {
    axios
      .put(
        `${url_user_customer}/${selectedCustomerId}`,
        formData,
        authorization
      )
      .then((res) => {
  ...
  useEffect(() => {
    const getAll = () => {
      axios
        .get(`${url_user_customer}`, authorization)
        .then((res) => {
